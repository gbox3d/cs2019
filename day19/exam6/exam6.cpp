...
LRESULT CALLBACK WndProc(HWND hWnd, UINT message, WPARAM wParam, LPARAM lParam)
{
	...
	case WM_CREATE:
	{
		...
		g_hSocket = socket(AF_INET, SOCK_DGRAM, IPPROTO_UDP); //소켓 생성 
	}	
		break;
    case WM_COMMAND:
        {
			...
			case IDM_SEND:
			{
				...
				InetPton(AF_INET, TEXT("192.168.0.15"), &si_other.sin_addr.s_addr);				
				...
				sendto(g_hSocket, (const char*)&pkt,sizeof(S_TESTPACKET) , 0,
